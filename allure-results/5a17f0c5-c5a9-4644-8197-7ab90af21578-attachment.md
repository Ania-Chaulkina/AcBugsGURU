...
- dialog:
  ...
  - paragraph: In this bug, the page freezes when changing the currency.
  - separator
  ...
  - list:
    ...
    - listitem: Open a product
    - listitem: Change the currency in the right side menu
  - heading "Expected Result" [level=6]
  - paragraph: The currency is changed as expected
  - heading "Actual Result" [level=6]
  - paragraph: The page freezes when changing the currency
